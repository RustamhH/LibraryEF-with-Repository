        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOut = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 21, 22, 5, 34, 115, DateTimeKind.Local).AddTicks(851)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_Book = table.Column<int>(type: "int", nullable: false),
                    Id_Lib = table.Column<int>(type: "int", nullable: false),
                    DateOut = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 21, 22, 5, 34, 114, DateTimeKind.Local).AddTicks(1036)),
                    DateIn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
